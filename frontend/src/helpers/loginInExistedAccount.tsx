...
const loginInExistedAccount = async (name:string, password: string, toast:any) => {
    // try {
    //     const walletContract = new Contract(
    //         "0x5FbDB2315678afecb367f032d93F642f64180aa3",
    //         wallet.abi,
    //         providers.getSigner())
    //     const tx = await walletContract.validateLoginIn(name, password)
    //     const hash = tx.hash;
    ...
    //     } else {
    //         Swal.close();
    //         throw new Error("Login Failed during transaction");
    //     }
    // } catch (error: any) {
    //     toast({
...
export default loginInExistedAccount