...
const changeSecurityModulePreference = async (moduleType:string, changeType:any, toast:any) => {
    // try {
    //     const walletContract = new Contract(
    //         "0x5FbDB2315678afecb367f032d93F642f64180aa3",
    //         wallet.abi,
    //         providers.getSigner())
    //     const tx = await walletContract.changeModuleStatus(moduleType, changeType)
    //     const hash = tx.hash;
...
export default changeSecurityModulePreference