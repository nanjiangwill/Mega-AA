...
export default function UpdateTable({ className }) {
  ...
  useEffect(() => {
    const loadTx = async () => {
      ...
      const txsNew = txs.sort((a, b) => a.timestamp - b.timestamp);
      const txsTimeClean = txsNew.map((tx) => {
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <tbody>
            ...
            <tr className="text-base text-thin-light-gray whitespace-nowrap px-2 border-b default-border-bottom ">
              ...
              <td className="py-4 whitespace-nowrap text-center">From(Chain ID)</td>
              <td className="py-4 whitespace-nowrap text-center">To(Chain ID)</td>
              <td className="py-4 whitespace-nowrap text-center">Sender Chain Hash</td>
              <td className="py-4 whitespace-nowrap  text-center">Recipient Chain Hash</td>
                  ...
                  <td className="text-center py-4 px-2">
                    <div className="flex space-x-1 items-center justify-center">
                      <span className="text-base text-dark-gray font-medium whitespace-nowrap">
                        {tx.origin in chain ? chain[tx.origin] : "Unknown"}
                        </span>
                    </div>
                  </td>
                  <td className="text-center py-4 px-2">
                    <div className="flex space-x-1 items-center justify-center">
                      <span className="text-base text-dark-gray font-medium whitespace-nowrap">
                      {tx.destination in chain ? chain[tx.destination] : tx.destination}
                      </span>
                    </div>
                  </td>
                  <td className="text-center py-4 px-2">
